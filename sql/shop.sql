...
(
SDT nvarchar(10) not null primary key,
MatKhau nvarchar(10),
TrangThai bit,
)
create table ChucVu
(
ChucVu int not null primary key, 
...
(
MaNhaCungCung int not null primary key,
MaSp nvarchar(10),
...
(
MaPhieuXuat nvarchar(10) not null primary key,
NgayLap datetime,
TongTien money,
ChiecKhau nvarchar(10),
ThanhToan money,
...
ADD CONSTRAINT fk_phieunhap_ctphieuxuat
  ...
  REFERENCES PhieuXuat(MaPhieuXuat);
   ALTER TABLE CTPhieuXuat
   add constraint ctphieuxuat_pk primary key (MaPhieuXuat, MaSP)
   ALTER TABLE CTPhieuNhap
   add constraint ctphieunhap_pk primary key (MaPhieuNhap, MaSP)
   ALTER TABLE CTHoaDon
